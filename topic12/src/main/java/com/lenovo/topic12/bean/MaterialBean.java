...
public class MaterialBean {
    ...
    public static class DataBean {
        ...
        public int supplyListId;
        public int productionLineClass;
        ...
        public int getProductionLineClass() {
            return productionLineClass;
        }

        public void setProductionLineClass(int productionLineClass) {
            this.productionLineClass = productionLineClass;
        }
